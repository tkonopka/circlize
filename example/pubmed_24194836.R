...
## re-produced from <a href="http://www.plosone.org/article/info%3Adoi%2F10.1371%2Fjournal.pone.0076376">Jimmy H. W. Saw et al, Plos ONE, 2013</a>
...
circos.genomicTrackPlotRegion(cytoband, stack = TRUE, panel.fun = function(region, value, ...) {
	...
	circos.text(major.at[l], rep(1.7, sum(l)), paste0(major.at[l]/1000000, "MB"), cex = 0.8, facing = "clockwise", adj = c(0, 0.5))
